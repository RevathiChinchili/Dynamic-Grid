var productList = [
  ...
  let clothingHeading= document.createElement('h1')
  clothingHeading.classList.add("heading")
  clothingHeading.append("Clothing for Men and Women")

  let accessoryHeading= document.createElement('h1')
  accessoryHeading.classList.add("heading1")
  accessoryHeading.append("Accessories for Men and Women")

  body.append(clothingHeading)
  body.append(accessoryHeading)
  

  let clothingContainer= document.createElement('div')
  clothingContainer.classList.add("containerClothing")
  clothingContainer.setAttribute('id','containerClothing1')

  let accessoryContainer= document.createElement('div')
  accessoryContainer.classList.add("containerAccessory")
  accessoryContainer.setAttribute('id','containerAccessory1')
  ...
  productList.map((product)=>{
    ...
    box.classList.add('clothing')
    box.id=product.id

    let box1= document.createElement('div')
    box.id=product.id

    if(product.isAccessory==false){//it is clothing item
      ...
      newImg.src=product.preview
       ...
       body.append(clothingContainer)
       clothingContainer.append(box)
       box.append(newCard)
       newCard.append(newImg)
       
       let name=document.createElement('div')
       name.classList.add('heading2')
       let clothingName= document.createElement('h2')
       clothingName=product.name
       body.append(clothingContainer)
       clothingContainer.append(box)
       box.append(name)
       name.append(clothingName)
       
       let brand=document.createElement('div')
       brand.classList.add('heading2')
       ...
       let priceVal= document.createElement('h3')
       priceVal=product.price
       body.append(clothingContainer)
       clothingContainer.append(box)
       box.append(price)
       price.append('Rs ',  priceVal)


    }

    else if(product.isAccessory == true){
      let newCard= document.createElement('div')
       //newCard.classList.add('image')
       let newImg= document.createElement('img')
       newImg.classList.add('image')
       ...
       body.append(accessoryContainer)
       accessoryContainer.append(box1)
       box1.append(newCard)
       newCard.append(newImg)

       let name=document.createElement('div')
       name.classList.add('heading2')
       let accessoryName= document.createElement('h2')
       accessoryName=product.name
       body.append(accessoryContainer)
       accessoryContainer.append(box1)
       box1.append(name)
       name.append(accessoryName)
